...
import BlogCardMobile from './BlogCard';
import {
...
function BlogCardsMobile() {
  const { locale } = useLocale();
  return (
    <Container>
      <Title>بلاگ مهاجرت</Title>
      <Subtitle>
        صفحه وبلاگ های ما خوش آمدید، جایی که ما اطلاعات، نکات و اخبار مربوط به
        مهاجرت خود را به اشتراک می گذاریم.
      </Subtitle>
      <Wrapper>
        <BlogCardMobile
...
export default BlogCardsMobile;
