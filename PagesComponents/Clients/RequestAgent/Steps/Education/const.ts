...
export enum LanguageKeys {
  ...
  BackTitle = "BackTitle",
  // add Degree Warning
  AddDegreeWarning = "AddDegreeWarning",
}
...
`,
  ...
  AddInfoSwiper: {
    en: "Add educational qualification",
    fa: "افزودن مشخصات مدرک تحصیلی",
    zh: "添加学历",
  },
  AddDegreeWarning: {
    en: "Enter the information of all your educational qualifications.",
    fa: "اطلاعات تمامی مدارک تحصیلی خود را وارد کنید.",
    zh: "输入您所有的学历信息。",
  },
};
