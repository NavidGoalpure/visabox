    ...
    <Container>
      ...
      <ThreeItemWrapper>
        <StyledBlogCardType2Slim
          ...
          href={`navidblogs/${blogs[0]?.slug?.current || '#'}`}
        />
        ...
        <StyledBlogCardType2SlimBelow
          ...
          href={`navidblogs/${blogs[1]?.slug?.current || '#'}`}
        />
        ...
        <StyledBlogCardType1Slim
          ...
          href={`navidblogs/${blogs[2]?.slug?.current || '#'}`}
        />
      </ThreeItemWrapper>
      <TwoItemWrapper>
