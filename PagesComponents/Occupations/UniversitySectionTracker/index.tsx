  ...
  return (
    <Container>
      <Wrapper>
        ...
        <Desc>
          برای این کار اسم دانشگاه یا شهری که دانشگاه در آن واقع شده را جستجو
          کنید و دانشگاه خود را از بین گزینه های موجود پیدا کنید. توجه کنید که
          برای شروع این جستجو، حداقل باید سه حرف را وارد کنید.
        </Desc>
        <SearchInputComponent placeholder="جستجو" theme={"LAYER2"} />
      </Wrapper>
    </Container>
  );
};
