...
export const componentStatements: Record<LanguageKeys, MultiLanguageText> = {
  ...
  SeoDesc: {
    en: 'Business name: $businessName | address: $address  | Mara Box',
    fa: 'دفتر وکالت: $businessName | آدرس: $address  | Mara Box',
    zh: '企业名称: $businessName | 地址: $address  | Mara Box',
  },
  //
  ...
  NoAgentSub: {
    en: `Sorry, we couldn't find the page you're looking for. Please check the URL you entered or try searching for what you need. If you believe this is an issue on our end, please contact with maraboxmigration@gmail.com`,
    fa: 'متاسفانه، صفحه مورد نظر شما پیدا نشد. لطفاً URL وارد شده را بررسی کنید. اگر فکر می کنید که این یک مشکل در طرف ما است، لطفاً با maraboxmigration@gmail.com تماس بگیرید',
    zh: '抱歉，我们找不到您要查找的页面。 请检查您输入的 URL 或尝试搜索您需要的内容。 如果您认为这是我们的问题，请联系 maraboxmigration@gmail.com',
  },
  MaraPageButton: {
