    ...
    <main>
      ...
      {isSubmitted ? (
        <div className='flex flex-col py-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto'>
          <h3 className='text-3xl font-bold'>Thankyou for submit!</h3>
        ...
        >
          <h3 className='text-sm text-yellow-500'>Enjoyd this article</h3>
          <h4 className='text-3xl foot-bold'>Leave a comment below!</h4>
          ...
          focus:sahdow-outline focus:outline-none text-white
